# Generated by Django 5.1.3 on 2025-01-23 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.role', verbose_name='Роль')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.product', verbose_name='Номер товара')),
                ('id_status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.status', verbose_name='Статус заказа')),
            ],
        ),
    ]
